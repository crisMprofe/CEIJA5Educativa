...
import { obtenerRegistrosSinDocumentacion, limpiarDuplicadosManualmente, verificarDuplicados, testearSistema7Dias, obtenerDocumentosRequeridos } from '../utils/registroSinDocumentacion';
import registrosPendientesService from '../services/serviceRegistrosPendientes';
import { useGlobalAlerts } from '../hooks/useGlobalAlerts';
import CloseButton from './CloseButton';

// Removed unused imports: HeaderModal, ListaRegistrosPendientes, SeccionEmails, SeccionDescargas, SeccionDuplicados
// import SeccionDuplicados from './registrosPendientes/SeccionDuplicados'; // Removed unused import
                                        ...
                                        <div key={registro.id || index}
                                            ...
                                            <div className="registro-grid">
                                                ...
                                                <div className="registro-acciones">
                                                    ...
                                                    <button
                                                        onClick={() => {
                                                            console.log('🧪 [DEBUG] Botón Eliminar clickeado para registro:', registro);
                                                            // TEMPORAL: Eliminar directamente sin confirmación para debugging
                                                            const nombreCompleto = `${registro.datos?.nombre || registro.nombre} ${registro.datos?.apellido || registro.apellido}`;
                                                            procesarEliminacion(registro, nombreCompleto);
                                                        }}
                                                        className="btn-eliminar"
                                                        title="Eliminar este registro permanentemente (SIN CONFIRMACIÓN - DEBUGGING)"
                                                        disabled={enviandoEmail}
                                                        style={{
